...
SevenEval::SevenEval()
{
	int face[13] = { ACE, KING, QUEEN, JACK, TEN, NINE, EIGHT, SEVEN,
          ...
          for (int m = 0; m <= l; m++)
            ...
            for(int n = 0; n <= m; n++)
              ...
              for(int p = 0; p <= n; p++)
                ...
                if(i != m && j != n && k != p)
								{
                  int key = face[i] + face[j] + face[k] + face[l] + face[m] +
														face[n] + face[p];
        ...
        for(int l = 3; l < k; l++)
          ...
          for(int m = 2; m < l; m++)
            ...
            for(int n = 1; n < m; n++)
              ...
              for(int p = 0; p < n; p++)
							{
                int key = faceFlush[i] + faceFlush[j] + faceFlush[k] +
...
short SevenEval::getRankOfSeven(const int CARD1,
																const int CARD2,
																const int CARD3,
																const int CARD4,
																const int CARD5,
																...
																const int CARD7)
{
	...
	unsigned long KEY = deckcardsKey[CARD1] +
											deckcardsKey[CARD2] +
											deckcardsKey[CARD3] +
											deckcardsKey[CARD4] +
											deckcardsKey[CARD5] +
