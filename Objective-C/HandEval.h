...
// We cite the FiveEval class for booting up
// the HandEval instance. An instance of FiveEval
// is used to generate the seven-card ranks.
...
- (NSString *) computePreFlopEquityForSpecificHoleCards:(int *) holeCards
                                    withNumberOfPlayers:(int) number_of_players;

- (NSString *) computeFlopEquityForSpecificHoleCards:(int *) holeCards
                                      withTableCards:(int *) tableCards
