...
/*!
 The corresponding method in SevenEval.h is superior. This one is only used to
 initialise the 7-card evaluator as it carries of the overhead of having to
