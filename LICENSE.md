...
"Contribution" shall mean, as intended to be submitted to the Licensor for
...
Contribution has been received by the Licensor and incorporated within the
Work.
...
4. If the Work includes a "NOTICE" text file as part of its distribution,
   ...
   Derivative Works that You distribute, alongside or in addition to the
   ...
   distribute, sublicense, and/or sell copies of Your modifications, and to
   permit persons to whom Your modifications are furnished to do so.
...
stoppage, computer failure or malfunction, or all other commercial damages
...
However, in accepting such obligations, You may offer such obligations only
...
enclosed in the appropriate comment syntax for the file format in use.
